...
void StateMachineTask::init() {
  ...
  next_state_state_machine_table[TRANCADA_IDLE][SINAL_VALIDO] =
      DESTRANCADA_FECHADA;
  ...
  next_state_state_machine_table[DIGITANDO_SENHA][SINAL_INVALIDO] =
      DIGITANDO_SENHA;
  action_state_machine_table[DIGITANDO_SENHA][SINAL_INVALIDO] = A03;
  next_state_state_machine_table[DIGITANDO_SENHA][SINAL_VALIDO] =
      DESTRANCADA_FECHADA;
  ...
  next_state_state_machine_table[DIGITANDO_SENHA][SENHA_INVALIDA] =
      TRANCADA_IDLE;
  action_state_machine_table[DIGITANDO_SENHA][SENHA_INVALIDA] = A06;
  next_state_state_machine_table[DIGITANDO_SENHA][SENHA_VALIDA] =
      DESTRANCADA_FECHADA;
